...
export default function Header() {
  ...
  return (
    <header className="sticky z-50 top-1 w-full bg-background/80 backdrop-blur-xs px-0 md:px-20 md:py-2 rounded-full md:rounded-none not-md:border-2 overflow-hidden">
