...
interface GradualBlurMemoType extends React.NamedExoticComponent<GradualBlurProps> {
  PRESETS: Record<string, Partial<GradualBlurProps>>;
  CURVE_FUNCTIONS: Record<string, (p: number) => number>;
}

const GradualBlurMemoWithStatics = GradualBlurMemo as GradualBlurMemoType;
GradualBlurMemoWithStatics.PRESETS = PRESETS;
GradualBlurMemoWithStatics.CURVE_FUNCTIONS = CURVE_FUNCTIONS;

export default GradualBlurMemoWithStatics;
